...
function AdminProfile() {
    ...
    const [updatedAuth, setUpdatedAuth] = useState({ first_name: "", last_name: "", dob: "", avatar: "", phoneNumber: "", });
    ...
    const clearModal = () => {
        setUpdatedAuth({ first_name: "", last_name: "", dob: "", avatar: "", phoneNumber: "", });
    ...
    return (
        <div className="w-full h-screen overflow-auto pt-24 px-10">
            <div className="flex justify-between border-b-2 pb-16 relative">
                ...
                <p className="absolute bottom-[-1px] border-b-2 uppercase text-xs pc:text-lg pb-2 border-main-1 text-main-1">{auth?.role}</p>
            </div>
