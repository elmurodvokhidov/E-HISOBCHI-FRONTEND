    ...
    return (
        <>
            ...
            <div
                ...
                className={`${modals.financeModal ? `pc:left-[142px] lg:left-[130px] md:left-[110px] small:left-[101px] right-0` : `-left-[100%]`} h-screen absolute top-0 z-10 transition-all`}>
            ...
            <div
                ...
                className={`${modals.settingsModal ? `pc:left-[142px] lg:left-[130px] md:left-[110px] small:left-[101px] right-0` : `-left-[100%]`} h-screen absolute top-0 z-10 transition-all`}>
                <div className='extraModal pc:w-[350px] md:w-72 small:w-60 h-full pt-24 overflow-y-auto shadow-dim-right bg-white'>
                    <Link
                        onClick={closeAllModals}
                        to="courses"
