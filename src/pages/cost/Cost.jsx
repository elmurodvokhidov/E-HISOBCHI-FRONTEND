    ...
    const filteredCosts = costs.filter(cost => {
        return Object.entries(filters).every(([key, value]) => {
            ...
            if (key === 'amountFrom' || key === 'amountTo') {
                const sum = Math.floor(Math.abs(cost.amount));
            ...
            <div className="relative px-[40px]">
                ...
                <div className="flex items-center justify-between mt-3 rounded-md shadow-md bg-white">
                    <div className="flex items-center gap-2 text-xl">
                        ...
                        <h1>Jami:</h1>
                        <h1>{Math.floor(costs.reduce((total, cost) => total + (+cost.amount), 0)).toLocaleString()} UZS</h1>
                    </div>
                        ...
                        filteredCosts.length > 0 ? <>
                            {
                                filteredCosts.map(cost => (
                                    <div
                                        ...
                                        <div className="min-w-[100px] flex gap-2 pl-3">
                                            <button
                                                onClick={() => updateBtnFunc(cost)}
                                                className="text-base"
                                            >
