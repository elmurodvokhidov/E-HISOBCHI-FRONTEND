...
function Login() {
    ...
    return (
        <div className="w-full h-screen overflow-y-auto flex flex-col items-center justify-start gap-4 p-6 bg-gray-200">
            <div className="md:w-[45%] sm:w-[80%] small:w-full flex flex-col gap-4">
                {/* Cover Image */}
                ...
                <form className="w-full flex lg:flex-row small:flex-col items-center gap-10 px-6 py-10 rounded shadow-smooth bg-white">
                    {/* Logo */}
                    <figure>
                        <img
                            crossOrigin="anonymous"
                            src="https://backend.e-hisobchi.uz/api/uploads/uitc.png"
                            alt="logo"
